public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subtask subtask4 = new Subtask(7, "Подготовка к собеседованию", "Начать познавать алгоритмы", Status.IN_PROGRESS, epic.getId());
        taskManagerService.updateSubtask(subtask4);
        Epic epic3 = new Epic(8, "Переехать в Дублин", "Релоцироваться как сотрудник");
        ...
        taskManagerService.removeSubtask(7);
